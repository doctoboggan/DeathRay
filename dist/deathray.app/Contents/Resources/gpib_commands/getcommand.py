...
class getcommand(data_acquisition.vxi_11.vxi_11_connection,data_acquisition.gpib_utilities.gpib_device,data_acquisition.vxi_11.VXI_11_Error):		
  """
  ...
  def __init__(self, IPad = '127.0.0.1', Gpibad ="inst0" , namdev = "Network Device", command ='*IDN?', timeout=2000): 
    ...
    rise_on_error = 0
    data_acquisition.vxi_11.vxi_11_connection.__init__(self,host=self.ip_id,device=self.gpib_id,raise_on_err=rise_on_error,timeout=timeout,device_name=namdev)  #here we are feeding the data_acquisition library
